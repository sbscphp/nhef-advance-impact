...
use App\Repositories\CustomField\CustomFieldDefinitionRepository;
use App\Repositories\CustomField\CustomFieldValueRepository;
...
use App\Repositories\Project\ProjectBroadcastRepository;
use App\Repositories\Project\ProjectBudgetLineRepository;
use App\Repositories\Project\ProjectDeliverableRepository;
use App\Repositories\Project\ProjectDocumentRepository;
use App\Repositories\Project\ProjectExpenditureRepository;
use App\Repositories\Project\ProjectImpactReportRepository;
use App\Repositories\Project\ProjectMilestoneRepository;
use App\Repositories\Project\ProjectObjectiveRepository;
use App\Repositories\Project\ProjectRepository;
use App\Repositories\Project\ProjectRiskRepository;
use App\Repositories\Research\ResearchDeliverableRepository;
use App\Repositories\Research\ResearchMilestoneRepository;
use App\Repositories\Research\ResearchObjectiveRepository;
use App\Repositories\Research\ResearchRepository;
use App\Repositories\Reporting\GeneratedReportRepository;
use App\Repositories\TertiaryInstitution\TertiaryInstitutionRepository;
...
class AppServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->bind(TertiaryInstitutionRepositoryInterface::class, TertiaryInstitutionRepository::class);
        ...
        $this->app->bind(CustomFieldDefinitionRepositoryInterface::class, CustomFieldDefinitionRepository::class);
        $this->app->bind(CustomFieldValueRepositoryInterface::class, CustomFieldValueRepository::class);
        $this->app->bind(GeneratedReportRepositoryInterface::class, GeneratedReportRepository::class);
        $this->app->bind(ProjectRepositoryInterface::class, ProjectRepository::class);
        $this->app->bind(ProjectObjectiveRepositoryInterface::class, ProjectObjectiveRepository::class);
        $this->app->bind(ProjectMilestoneRepositoryInterface::class, ProjectMilestoneRepository::class);
        $this->app->bind(ProjectDeliverableRepositoryInterface::class, ProjectDeliverableRepository::class);
        $this->app->bind(ProjectBudgetLineRepositoryInterface::class, ProjectBudgetLineRepository::class);
        $this->app->bind(ProjectExpenditureRepositoryInterface::class, ProjectExpenditureRepository::class);
        $this->app->bind(ProjectImpactReportRepositoryInterface::class, ProjectImpactReportRepository::class);
        $this->app->bind(ProjectDocumentRepositoryInterface::class, ProjectDocumentRepository::class);
        $this->app->bind(ProjectBroadcastRepositoryInterface::class, ProjectBroadcastRepository::class);
        ...
        $this->app->bind(ResearchObjectiveRepositoryInterface::class, ResearchObjectiveRepository::class);
        $this->app->bind(ResearchMilestoneRepositoryInterface::class, ResearchMilestoneRepository::class);
        $this->app->bind(ResearchDeliverableRepositoryInterface::class, ResearchDeliverableRepository::class);
