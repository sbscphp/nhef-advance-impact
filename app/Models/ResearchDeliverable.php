...
class ResearchDeliverable extends Model
{
    use HasUuid;
    ...
    {
        return $this->belongsToMany(Admin::class, 'research_deliverable_notify_recipients', 'deliverable_id', 'admin_id')->withTimestamps();
    }
