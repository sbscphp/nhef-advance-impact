...
/**
 * Event registration confirmation email (BRD EVT-02/ENT-04), for guest registrants who have
 * no account to receive an in-app notification; see EventTicketService::notifyRegistrationConfirmed().
 */
